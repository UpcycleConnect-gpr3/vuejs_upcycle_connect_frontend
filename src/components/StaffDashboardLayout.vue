...
const displayName = computed(() => userEmail.value || t('staffLayout.defaultAccount'))
...
const animationNav = [
  {
    labelKey: 'staffLayout.nav.overview',
    to: '/staff',
  ...
  {
    labelKey: 'staffLayout.nav.trainings',
    to: '/staff/trainings',
  ...
  {
    labelKey: 'staffLayout.nav.planning',
    to: '/staff/planning',
...
const contenusNav = [
  {
    labelKey: 'staffLayout.nav.advice',
    to: '/staff/advice',
  ...
  {
    labelKey: 'staffLayout.nav.moderation',
    to: '/staff/moderation',
    ...
    <aside class="dashboard-sidebar">
      ...
      <nav class="dashboard-sidebar-nav">
        <div class="dashboard-sidebar-section">
          <span class="sidebar-section-title">{{ $t('staffLayout.sections.animation') }}</span>
        ...
        <div class="dashboard-sidebar-section">
          <span class="sidebar-section-title">{{ $t('staffLayout.sections.content') }}</span>
          <ul class="sidebar-nav-list">
