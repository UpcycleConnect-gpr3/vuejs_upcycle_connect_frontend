...
// Espace d'accueil de chaque role (les 4 espaces du sujet UpcycleConnect).
// L'administrateur utilise le back office (application dediee) mais peut
// naviguer partout dans cette application.
